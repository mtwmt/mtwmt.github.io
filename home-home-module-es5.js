  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    function vUh(module, __webpack_exports__, __webpack_require__) {
      ...
      HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 7,
        vars: 0,
        consts: [[1, "pr-32", "md:pr-10", "text-right"], ["src", "/assets/img/monkey.png", "alt", "welcome to Mandy's website", 1, "inline-block", "w-9/12"], [1, "p-6", "bg-oreilly-500", "text-white"], [1, "text-6xl", "pb-6", "border-b-2", "border-white", "leading-none", "font-serif"], [1, "text-xl", "mt-2", "leading-tight"]],
