import{p as d}from"./purify.es.A66Cw1IH.js";const i="Mandy's Website",l=(t,e,n)=>{if(e){{const r=new RegExp(e,"igm");t=t.replace(r,'<span class="bg-orange-500 text-white px-1 rounded">$&</span>')}return t}};let o;const a=document.querySelector("#search"),m=document.querySelector("#searchReadout"),h=document.querySelector("#searchResults");function p(t){document.title=t?`${i} | 搜尋 “${t}”`:i}function f(t){const e=t?`搜尋：${t}`:"";m.textContent=e}const w=(t,e)=>t.map(n=>{const{title:r,date:c,slug:u}=n,s=new Date(c);return`<li class="py-4 px-[4vw]">
